...
public class RetrieveMultipleDataCommand<T extends Data> extends Command<RetrieveMultipleDataCommand<T>, Data>
{
	private final DataKey key;

	public RetrieveMultipleDataCommand(DataKey key) {
		this.key = key;

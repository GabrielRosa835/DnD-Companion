...
public class BuildArmorCommand extends DataBuilderCommand<ArmorData>
{
	private String name;
	private Price price;
	...
	public BuildArmorCommand(
		...
		this.name = ToolBox.to_snake_case(name);
		this.price = price;
		this.weight = weight;
		this.tags = ToolBox.to_snake_case(tags);
		this.description = description;
		this.category = ToolBox.to_snake_case(category);

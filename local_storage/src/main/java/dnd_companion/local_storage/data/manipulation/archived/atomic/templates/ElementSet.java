...
public abstract class ElementSet<IElement extends Element, IElementCollection extends ElementSet<IElement, IElementCollection>> implements Set<IElement>
{
	...
	public ElementSet(Collection<IElement> elements) {
		for (IElement element : elements) {
			this.values.add(element);
		}
	}
	public ElementSet(IElementCollection element_cluster) {

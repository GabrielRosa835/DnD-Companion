...
public class PriceComponent implements UnitComponent
{
	...
	public PriceComponent(double value, String unit_name) {
		this.value = value;
		this.unit = new Unit(unit_name);
	}
	
	@Override
	public PriceComponent convert_to(String unit_name) {

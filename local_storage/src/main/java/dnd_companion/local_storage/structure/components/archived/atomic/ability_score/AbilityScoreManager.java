package dnd_companion.local_storage.structure.components.archived.atomic.ability_score;

import java.util.Collection;

import dnd_companion.local_storage.structure.components.templates.AbstractManager;

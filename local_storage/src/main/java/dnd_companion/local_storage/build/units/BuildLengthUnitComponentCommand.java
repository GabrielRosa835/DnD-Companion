...
public class BuildLengthUnitComponentCommand extends Command<BuildLengthUnitComponentCommand, LengthUnitComponent>
{
	...
	@Override public void code() throws InvalidDataException {
		...
		this.message = "Length unit's build was successfull: " + key.toString();
	}
}

...
import app.rpg.snippets.operations.CalculateAbilityScoreModifier;
import app.rpg.elements.models.Component;
import app.rpg.elements.options.abilityScores.AbilityScoreOption;
import app.rpg.elements.options.proficiencies.ProficiencyOption;
import lombok.*;
...
public class AbilityScoreComponent
	...
	public int modifier() {
		return CalculateAbilityScoreModifier.with(value);
	}

	@Override
	public void update(AbilityScoreComponent clone) {

package src.data_structure.java.archived.main.attributes;

import atomic.Technique;
import src.data_structure.java.archived.atomic.ability_score.AbilityScoreElement;
...
public class Skill implements Technique {
    ...
    public ProficiencyType proficiency() {
    ...
    @Override
    public SkillProficiencyOptions to_proficiency() {

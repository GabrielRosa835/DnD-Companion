package src.data_structure.java.archived.main.description;
...
public class Alignment {
    ...
    public String get_morality() {
        return morality;
    }

    public void set_morality(String morality) {
        this.morality = morality;
    }
    ...
    public String[] get_tendency() {
        return tendency.values().toArray(new String[0]);
    }

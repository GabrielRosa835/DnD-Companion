...
public class BranchingTree<T> {
    ...
    public Map.Entry<T, Node> root() {
        return this.root;
    }

    private Map.Entry<T, Node> current;

    public Map.Entry<T, Node> current() {
        return this.current;
    }
    ...
    public class Node {
        ...
        public T prev(T prev_pointer) {
            return this.prev_pointer = prev_pointer;
        }

        private Collection<T> next_pointers;

        public Collection<T> next() {
            return this.next_pointers;
        }

        public Collection<T> next(Collection<T> next_pointers) {
            return this.next_pointers = next_pointers;
        }

...
public class LSMUpdateTest extends CommandTest
{
	...
	public LSMUpdateTest execute() {
		DataKey data_key = DataBuilder.create_data_key(data);
		this.result = LocalStorageManager.update(data_key, data);
		return this;
	}	
}

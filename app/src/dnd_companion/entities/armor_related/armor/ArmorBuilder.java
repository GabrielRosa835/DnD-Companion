...
public class ArmorBuilder implements EntityBuilder
{
	...
	private Price price = new Price(0, new NullCurrencyUnit());
	private Weight weight = new Weight(0, new NullWeightUnit());
	private ItemTagEntity[] tags = new ItemTagEntity[] {};
	private String description = "No description";
	private ArmorCategoryEntity category = new NoArmor();

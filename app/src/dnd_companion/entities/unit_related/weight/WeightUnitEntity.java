...
public class WeightUnitEntity implements Entity, Unit
{
	...
	WeightUnitEntity(String name, String singular, String abbreviation, double normalizing_factor) {
		this.name = name;
	...
	@Override public String toString() {
		return String.format("WeightUnit[name=%s, singular=%s, abbreviation=%s, normalizing_factor=%s]",

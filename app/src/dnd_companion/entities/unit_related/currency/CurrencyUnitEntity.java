...
public class CurrencyUnitEntity implements Entity, Unit
{
	...
	CurrencyUnitEntity(String name, String plural, String abbreviation, double normalizing_factor) {
		this.name = name;
		this.plural = plural;
	...
	@Override public String toString() {
		return String.format("CurrencyUnit[name=%s, plural=%s, abbreviation=%s, normalizing_factor=%s]",

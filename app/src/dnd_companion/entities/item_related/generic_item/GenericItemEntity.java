package dnd_companion.entities.item_related.generic_item;
...
public class GenericItemEntity implements Entity, Item
{
	private String name;
	...
	GenericItemEntity (String name, Price price, Weight weight, ItemTagEntity[] tags, String description) {
		this.name = name;
		this.price = price;
		this.weight = weight;
		this.tags = tags;
	...
	private GenericItemEntity(GenericItemEntity entity) {
		this(
				entity.name, 
	...
	@Override public String toString() {
		return String.format("GenericItem[name=%s, price=%s, weight=%s, tags=%s, description=%s", 
				name, price.toString(), weight.toString(), Arrays.toString(tags), description);
	}
	@Override public GenericItemEntity clone() {
		return new GenericItemEntity(this);
	}
}

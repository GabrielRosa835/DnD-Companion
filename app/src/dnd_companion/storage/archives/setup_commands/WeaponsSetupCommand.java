...
import dnd_companion.actors.entities.item.weapons.WeaponData;
import dnd_companion.actors.entities.item.weapons.category.WeaponCategoryData;
import dnd_companion.actors.entities.item.weapons.mastery.WeaponMasteryData;
import dnd_companion.actors.entities.item.weapons.properties.WeaponPropertyData;
import dnd_companion.actors.entities.item.weapons.type.WeaponTypeData;
import dnd_companion.common.metadata.UnitsMetadata;

public class WeaponsSetupCommand
{
	public void code() {
